...
import Personnalisation from 'src/pages/Personnalisation.vue'
...
<template>
  <header class="flex space-x-48 justify-center bg-gray-500 p-3 text-white font-3xl">
    <RouterLink to="/personnalisation">Personnalisation</RouterLink>
